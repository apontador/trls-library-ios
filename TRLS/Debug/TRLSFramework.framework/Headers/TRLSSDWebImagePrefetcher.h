...
@interface TRLSSDWebImagePrefetcher : NSObject <TRLSSDWebImageManagerDelegate>
{
...
+ (TRLSSDWebImagePrefetcher *)sharedImagePrefetcher;

/**
 * Assign list of URLs to let TRLSSDWebImagePrefetcher to queue the prefetching,
